...
Для локального тестирования можно включить «демо-ботов» (`DEMO_BOTS=true`):
фейковые участники сами присоединяются к свежим поездкам, заполняют условия и
голосуют реакциями за рассчитанные города. В production флаг игнорируется.
